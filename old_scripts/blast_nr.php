...
$nt_db = "";
$aa_db = "/comp_sync/data/foreign/blast/db_nr/nr";

$lang1 = "NR (Non-Redundant Proteins)";
$lang2 = "NR";
...
<table>
  <tr>
    ...
    <th>sequence</th>
    <td><input type='radio' name='seq_type' value='aa'<?=$_POST["seq_type"] == "aa" || (!$_POST["seq_type"]) ? "checked=checked" : ""?>>aa</td>
