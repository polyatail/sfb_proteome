...
$nt_db = "/comp_node0/andrew/proj/sfb/20110212_blastdb_sfb_renamed/nt_genome";
$aa_db = "/comp_node0/andrew/proj/sfb/20110212_blastdb_sfb_renamed/nt_genome";
...
<table>
  <tr>
    ...
    <th>sequence</th>
    <td><input type='radio' name='seq_type' value='nuc'<?=$_POST["seq_type"] == "nuc" || (!$_POST["seq_type"]) ? "checked=checked" : ""?>>nt</td>
    <td><input type='radio' name='seq_type' value='aa'<?=$_POST["seq_type"] == "aa" ? "checked=checked" : ""?>>aa</td>
    <td><input type='radio' name='seq_type' value='bx'<?=$_POST["seq_type"] == "bx" ? "checked=checked" : ""?>>blastx</td>
...
if ($_POST["act"] == "BLAST") {
  ...
  if ($_POST["seq_type"] == "nuc") {
    ...
    $blast_cmd = "tblastn -num_threads 30 -db " . $aa_db;
  } elseif ($_POST["seq_type"] == "bx") {
    $blast_cmd = "tblastx -num_threads 30 -db " . $aa_db;
  } else {
