...
<big><big>BLAST Results: blastx SFB vs MetaHIT</big></big>
<br />
...
$my_table = "20101201_blast_sfb_metahit";
...
while ($data = mysql_fetch_array ($results)) {
  ...
  while ($data2 = mysql_fetch_array ($results2)) {
    ...
    print "    <td>" . round ($data2["length"] / ($data2["query_length"] / 3), 2) . "</td>\n";
    print "    <td>" . round ($data2["length"] / strlen ($data4["aa"]), 2) . "</td>\n";
