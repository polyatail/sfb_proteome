...
switch ($_GET["task"]) {
    case "fetch":
        ...
        echo "  <td>Bitscore</td>";
        echo "  <td>E-value</td>";
        echo "  <td>Interacts With (<a href='http://domine.utdallas.edu/cgi-bin/Domine' target='_blank'>DOMINE</a>)</td>";
        ...
        echo "<br><big><b>Potential Interactors in Mouse<b></big><br><br>";
        ...
        $interact_result = mysql_query ("SELECT * FROM 20110217_interact_mm9 WHERE locus_tag = '" . $this_locus_tag . "' ORDER BY num_domains DESC");
        ...
        echo "<br><big><b>Top 50 Hits</b></big><br><br>";
