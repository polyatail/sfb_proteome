...
<table cellpadding='4' cellspacing='0' style='font-size: 0.8em; font-weight: bold' width='1200'>
    ...
    <tr height='35'>
        ...
        <td colspan='3'>Localization&nbsp;&nbsp;&nbsp; <a href='?task=local&query=cytoplasmic'>Cytoplasmic</a> | <a href='?task=local&query=membrane'>Membrane</a> | <a href='?task=local&query=cellwall'>Cell Wall</a> | <a href='?task=local&query=extracellular'>Extracellular</a> | <a href='?task=local&query=unknown'>Unknown</a> | <a href='?task=local&query=NULL'>NULL</a></td>
    </tr>
</table>
...
switch ($_GET["task"]) {
    case "fetch":
        ...
        echo "  <tr height='45'>";
        echo "    <td width='600' valign='center' style='border: none'><big><b>NT Sequence</b></big><br><br></td>";
        echo "    <td width='600' valign='center' style='border: none'><big><b>AA Sequence</b></big><br><br></td>";
        echo "  </tr>";
...
function makequery ($type, $param1 = NULL, $param2 = NULL) {
    switch ($type) {
        ...
        case "local":
            ...
            break;
        case "search":
            $searchterm = "CONCAT_WS(\" \", note, curated_symbol, curated_name, baylor, baylor_symbol, baylor_ec_num, baylor_local, rast, img_er, kegg, kegg_symbol, kegg_name, og)";
