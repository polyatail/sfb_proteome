...
<table cellpadding='4' cellspacing='0' style='font-size: 0.8em; font-weight: bold' width='900'>
    <tr height='35'>
        <td rowspan='2' width='150'><center><big><big><big>PSI-BLAST<br>SFB vs NR</big></big></big></center></td>
    ...
    <tr height='35'>
        <td><a href="?task=haveko">Annotated by KAAS</a></td>
...
function print_list ($result) {
    ...
    echo "    <td width='49%'><b>Annotation</b></td>\n";
    echo "  </tr>\n";
...
switch ($_GET["task"]) {
    case "fetch":
        ...
        echo "    <td width='80%'>" . ($data["baylor"] ? "<b>Symbol:</b> " . ($data["baylor_symbol"] ? $data["baylor_symbol"] : "<i>NULL</i>") . "<br><b>Name:</b> " . $data["baylor"] . "<br><b>EC:</b> " . ($data["baylor_ec_num"] ? "<a href='http://www.expasy.ch/enzyme/" . $data["baylor_ec_num"] . "'>" . $data["baylor_ec_num"] . "</a>" : "<i>NULL</i>") : "<i>NULL</i>") . "</td>";
        echo "  </tr>";
        echo "  <tr>";
